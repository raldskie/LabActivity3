		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="text-center mt-2 mb-5">
					<h2 class="t-40 white">Ready To <span class="font-weight-bold">Collaborate</span><br> With Your Team?</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex" >
						<div class="img" style="background-image: url({{ asset('css/bg-1.jpg') }});">
			      </div>
